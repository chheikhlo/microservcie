...
class PersonneResourceIT {
    ...
    public static Personne createEntity(EntityManager em) {
        Personne personne = new Personne().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).tel(DEFAULT_TEL);
        return personne;
    }
    ...
    public static Personne createUpdatedEntity(EntityManager em) {
        Personne personne = new Personne().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).tel(UPDATED_TEL);
        return personne;
    }
    ...
    void putNewPersonne() throws Exception {
        ...
        updatedPersonne.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).tel(UPDATED_TEL);
    ...
    void fullUpdatePersonneWithPatch() throws Exception {
        ...
        partialUpdatedPersonne.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).tel(UPDATED_TEL);
